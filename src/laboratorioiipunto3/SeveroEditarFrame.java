 ...
 * @author myd.abogados
 */
public class SeveroEditarFrame extends JFrame {
    ...
    private SeveroEditarControl control;
    

    public SeveroEditarFrame() {
        IntSeveroEditar();
    }
    
    
    public void IntSeveroEditar(){
        
        this.control= new SeveroEditarControl(this);
        ...
        this.titulo.setText("Editar Contactos");
